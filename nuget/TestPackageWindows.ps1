...
$BuildTargets = @()
$BuildTargets += New-Object PSObject -Property @{Package = "WebPDotNet";     PlatformTarget="x64"; RID = "$OperatingSystem-x64"; }
#$BuildTargets += New-Object PSObject -Property @{Package = "WebPDotNet";     PlatformTarget="x86"; RID = "$OperatingSystem-x86"; }
