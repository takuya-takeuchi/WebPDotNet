...
namespace WebPDotNet
{
    ...
    internal sealed partial class NativeMethods
    {
        ...
        // If Linux, it will be converted to  libWebPDotNetNative.so
        // If MacOSX, it will be converted to  libWebPDotNetNative.dylib
        ...
        internal const string NativeLibrary = "WebPDotNetNative";
