...
$WebPDotNetRoot = Split-Path $SrcPath -Parent
$NugetPath = Join-Path $WebPDotNetRoot "nuget" | `
             Join-Path -ChildPath "BuildUtils.ps1"
import-module $NugetPath -function *

$Config = [Config]::new($WebPDotNetRoot, $Configuration, $Target, $Architecture, $Platform, $Option)
Build -Config $Config